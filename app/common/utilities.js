...
const degreeToDirection = function(num) {
  var val= Math.floor((num / 22.5) + .5);
  return constants.WIND_DIRECTIONS[(val % 16)];
}
 
const describeWindSpeed = function(speed) {
  if(speed < 0.3) {
    return 'calm';
...
const describeHumidity = function(humidity) {
...
const convertKelvinToCelsius = function(celsius) {
  return celsius - 273.15;
}
 
const describeTemperature = function(temp) {
...
const getIcons = function(icon_names) {
